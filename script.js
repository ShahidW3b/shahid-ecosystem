...
const research = [
  ...
  },
  {
    ...
    href: "https://www.ijser.in/abstract.php?paperid=SE25604130052",
    cta: "View paper overview",
    systemCta: "See applied security system",
    systemHref: "https://github.com/ShahidW3b/ai-security-risk-checker",
  },
  {
...
const authoritySignals = [
  {
    ...
    text: "Translating research into real products, interfaces, and workflows — extending beyond visual work into structured system design.",
    icon: "✦",
  },
  {
    title: "Case-Study Driven Presentation",
    text: "Designing structured digital environments with intent — beyond page delivery into system-level thinking.",
    icon: "⌘",
  },
  {
...
const contactFlows = [
  {
    ...
    messagePlaceholder:
      "Tell us about the system you want to build, improve, or redesign.",
    buttonText: "Start System Project",
    reviewText:
      "Requests are reviewed based on scope, feasibility, and system requirements.",
  ...
  },
  {
    ...
    messagePlaceholder:
      "Tell us about the research direction, paper, or collaboration idea.",
    buttonText: "Submit Research Inquiry",
    reviewText:
      "Research inquiries are reviewed based on relevance, clarity, and collaboration potential.",
    reviewTitle: "Review & Collaboration",
  },
  {
    key: "inquiry",
    ...
    icon: "✉",
    companyPlaceholder: "Company / Project / Idea",
    messagePlaceholder: "Describe your system, research, or goal",
    buttonText: "Start Conversation",
    reviewText:
      "Inquiries are reviewed and prioritized based on scope, clarity, and alignment.",
...
const contactReviewTitle = document.getElementById("contactReviewTitle");
const contactReviewText = document.getElementById("contactReviewText");
...
function openContactModal(key) {
  ...
  if (contactSubmitText) {
    contactSubmitText.textContent = flow.buttonText;
  }

  if (contactReviewTitle) {
    contactReviewTitle.textContent = flow.reviewTitle;
  }

  if (contactReviewText) {
    contactReviewText.textContent = flow.reviewText;
  }
