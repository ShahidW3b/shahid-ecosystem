...
export default async function handler(req, res) {
  ...
  <div style="margin:0;padding:0;background:#07142b;font-family:Arial,sans-serif;color:#e5edf7;">
    <div style="max-width:640px;margin:0 auto;background:#0b1220;">
      ...
      <!-- Logo Bar -->
      <div style="background:#0b1220;text-align:center;padding:24px 20px;border-bottom:1px solid rgba(56,189,248,0.25);">
        <div style="display:inline-block;background:#ffffff;padding:10px 14px;">
          <img 
            src="https://shahidw3b.com/logo/logo.png" 
            width="82" 
            alt="ShahidW3b Logo"
      ...
      <!-- Hero Banner -->
      <div style="background:linear-gradient(135deg,#0f2a4d,#07142b);padding:34px 28px;border-bottom:1px solid rgba(56,189,248,0.25);">
          ...
          <tr>
            <td align="left" style="vertical-align:middle;">
              <a href="https://shahidw3b.com" style="text-decoration:none;">
                <div style="display:inline-block;background:#ffffff;padding:8px 10px;margin-bottom:10px;">
                  <img 
                    src="https://shahidw3b.com/logo/logo.png" 
                    width="42"
                    alt="ShahidW3b Logo"
              ...
              <a href="https://axonyra.vercel.app/#home" style="text-decoration:none;">
                <div style="display:inline-block;background:#ffffff;padding:8px 10px;margin-bottom:10px;">
                  <img 
                    ...
                    width="48"
                    alt="Axonyra Logo"
                    style="display:block;border:0;border-radius:40%;"
                  />
                </div>
              </a>
